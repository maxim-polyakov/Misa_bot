...
#
        ...
        try:
            ...
            logging.exception(str('The exception is in commandpreprocessing.preprocess_text ' + str(e)))
...
#
        ...
        try:
            ...
            logging.exception(str('The exception is in commandpreprocessing.reversepreprocess_text ' + str(e)))
