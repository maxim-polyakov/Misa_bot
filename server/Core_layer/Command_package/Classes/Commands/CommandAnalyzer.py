...
class CommandAnalyzer(IAnalyzer.IAnalyzer):
    ...
    def neurocheck(cls, message_text, user):
        ...
        input = (
            ...
            "- Напиши, создай, сгенерируй, составь — запросы на создание контента (JSON, код, текст, примеры) — это 10\n"
            "- 'напиши' и 'найди' — разные команды: напиши = генерация, найди = поиск в интернете\n"
