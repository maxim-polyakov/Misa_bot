...
class CommandAnalyzer(IAnalyzer.IAnalyzer):
    ...
    def neurocheck(cls, message_text, user):
        ...
        input = (
            ...
            "- «скажи слово», «скажи что-то» (не про погоду) — 10\n"
            "- «скажи погода», «скажи \"погода\"» — просьба произнести слово, не запрос погоды = 10, не 7. «скажи погоду» = 7.\n"
            ...
            "- «атакуй X», «фас X», «пиздани X» (X — имя) — 4 или 5\n"
            "- Имя после команды — объект атаки, не 10.\n"
            "Несколько команд в одном сообщении — анализируй каждую часть отдельно. Обязательно верни ВСЕ номера.\n"
            "Примеры: «атакуй борю, скажи слово» → 4, 10. «атакуй ваню, скажи \"погода\"» → 4, 10 (или 5, 10).\n"
