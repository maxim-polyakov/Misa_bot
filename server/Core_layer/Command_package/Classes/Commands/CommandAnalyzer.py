...
class CommandAnalyzer(IAnalyzer.IAnalyzer):
    ...
    def neurocheck(cls, message_text, user):
        ...
        input = (
            ...
            "- «почисти», «очисти», «очисть», «очисти текст», «почисти текст», «убери лишнее», «удали стоп-слова» — 8 или 9\n"
            "- «убери лишнее из: X» (где X — любой текст) — всегда 8 или 9\n"
            "- «очисть текст от знаков препинания и поставь слово в изначальную форму» — 8 или 9\n"
            "- Любой запрос на очистку текста, удаление знаков препинания, приведение к начальной форме = 8 или 9\n"
