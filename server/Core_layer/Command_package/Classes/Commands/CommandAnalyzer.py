...
class CommandAnalyzer(IAnalyzer.IAnalyzer):
    ...
    def neurocheck(cls, message_text, user):
        ...
        input = (
            ...
            "- «скажи \"погода\"» или «скажи погода» в кавычках — просьба произнести слово, не запрос погоды = 10, не 7\n"
            ...
            "Несколько команд в одном сообщении — анализируй каждую часть отдельно. "
            "Пример: «атакуй борю, скажи слово» → 4 (или 5) и 10, т.к. «скажи слово» нет в списке.\n"
