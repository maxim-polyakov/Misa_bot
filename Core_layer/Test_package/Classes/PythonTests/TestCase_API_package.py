import unittest
from Core_layer.API_package.Classes.Calculators import SympyCalculator as calc
from Core_layer.API_package.Classes.Finders import WikiFinder as find
from Core_layer.API_package.Classes.Translators import GoogleTranslator as trans
